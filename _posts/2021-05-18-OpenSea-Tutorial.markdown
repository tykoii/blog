...
First, in order to interact with the Koi ecosystem, you need a wallet that is compatible with Arweave, since the NFTs will be stored on the Arweave permaweb. You can get a wallet, some AR, and some KOI all for free. If you need an Arweave wallet or some AR tokens, check out our [Arweave faucet tutorial](https://blog.openkoi.com/An-Arweave-faucet-tutorial/). If you need some KOI, head over to the [KOI faucet tutorial](https://blog.openkoi.com/How-To-Get-Free-Koi-A-Faucet-Wallet-Tutorial/).

**Lets get started**

Now that you have AR and KOI, let’s get started! To register your NFTs on the Koi Network, go to [koi.rocks](https://koi.rocks/contents) . There you will find the Top Content leaderboard. Each of the NFTs on the leaderboard earns tokens every time you or anyone loads the page, so if you can get in the top 10, you’ll be earning right and left and center.
