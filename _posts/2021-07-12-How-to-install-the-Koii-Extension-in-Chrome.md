...
To download the extension, go to [koii.network/finnie.zip](https://koii.network/finnie.zip){:target="\_blank"}. This will automatically begin the download. Then unzip (or extract) the folder.
